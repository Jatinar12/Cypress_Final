Feature: Patient Registration
  ...
  Scenario Outline: User navigates to the Patient Registration and signs up with invalid data
    ...
    Examples:
      ...
      | Homepage  | sam   | abc@abc.com | 98765432115   | Patient Registration | Please enter a valid 10-digit mobile number! |
...
Scenario Outline: User is not able to register with existing mobile number & email
  ...
  Examples
    ...
    | Homepage |Hunter Brown | hunterbrown@gmail.com|  9541308298   |  9797@Qwerty | Male      |   Patient Registration|  5    | 5     | 1998  |test@testuser1.com | 9541308298 |    Mobile number already exists!|
